                ...
                <UPageBody prose class="prose-lg dark:text-gray-300">
                    ...
                    >
                        <template #headline>
                            ...
                            >
                                <UIcon
                                    v-if="feature.hero.headline.left_icon"
                                    :name="feature.hero.headline.left_icon"
                                    class="mr-1 w-4 h-4 pointer-events-none"
                                />
                                <NuxtLink
                                    :to="feature.hero.headline.to"
                                    target="_blank"
                                ...
                                <UIcon
                                    v-if="feature.hero.headline.right_icon"
                                    :name="feature.hero.headline.right_icon"
