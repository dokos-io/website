...
const title = partner.value.title;
const description = partner.value.description;
useSeoMeta({
    ...
    <UPage v-if="partner">
        <UContainer>
            ...
            >
                ...
                <div
                    class="flex flex-col lg:flex-row lg:items-center gap-3 mt-4"
                >
                    ...
                    <span
                        ...
                        class="hidden lg:block text-gray-500 dark:text-gray-400"
                        >&bull;</span
                    >

                    <NuxtLink
                        v-if="partner.twitter"
                        :to="`https://twitter.com/${partner.twitter}`"
                        target="_blank"
                    ...
                    <NuxtLink
                        v-if="partner.github"
                        :to="`https://github.com/${partner.github}`"
                        target="_blank"
                        class="flex items-center gap-1.5 hover:text-primary"
                    >
                    ...
                    <NuxtLink
                        v-if="partner.gitlab"
                        :to="`https://gitlab.com/${partner.gitlab}`"
                        target="_blank"
                        class="flex items-center gap-1.5 hover:text-primary"
                    >
