...
const { data: page } = await useAsyncData("production-companies", () =>
    queryContent(`/${locale.value}/production-companies`).findOne()
);
if (!page.value) {
    throw createError({
        statusCode: 404,
                    ...
                    >
                        <template #headline>
                            <UBadge
                                ...
                                :variant="
                                    page.colored_section.badge.variant ||
                                    'subtle'
                                "
                                :size="page.colored_section.badge.size || 'lg'"
                                :color="
                                    page.colored_section.badge.color ||
                                    'primary'
                                "
                                class="relative rounded-full font-semibold"
                            >
                                ...
                                <UIcon
                                    ...
                                    :name="
                                        page.colored_section.badge.right_icon
                                    "
                                    class="ml-1 w-4 h-4 pointer-events-none"
                                />
                            </UBadge>
